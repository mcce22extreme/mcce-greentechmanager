...
namespace GreenTechManager.Identity
{
    public static class DataSeed
    {
        ...
        public static void Seed(IApplicationBuilder app)
        {
            ...
            // Seed data
            CreateUser(userManager, "windparkadmin", PASSWORD, ROLE_WINDPARK_ADMIN, ROLE_WINDPARK_USER);
            CreateUser(userManager, "windparkuser", PASSWORD, ROLE_WINDPARK_USER);

            CreateUser(userManager, "solarparkadmin", PASSWORD, ROLE_SOLARPARK_ADMIN, ROLE_SOLARPARK_USER);
            CreateUser(userManager, "solarparkuser", PASSWORD, ROLE_SOLARPARK_USER);

            CreateUser(userManager, "operatoradmin", PASSWORD, ROLE_OPERATOR_ADMIN, ROLE_OPERATOR_USER);
